...
class TestBookingRequest:
    ...
    def test_valid_booking_request(self):
        ...
        assert request.device_mode == "mobile"  # Default value

    def test_booking_request_with_mobile_mode(self):
        """Test booking request with mobile device mode."""
        data = {
            "login_url": "https://example.com",
            "booking_date": "2025-12-01",
            "start_time": "21:30",
        ...
        request = BookingRequest(**data)
        assert request.device_mode == "mobile"

    def test_booking_request_with_desktop_mode(self):
        """Test booking request with desktop device mode."""
        data = {
            "login_url": "https://example.com",
            "booking_date": "2025-12-01",
            "start_time": "21:30",
        ...
        request = BookingRequest(**data)
        assert request.device_mode == "desktop"

    def test_invalid_device_mode(self):
        """Test that invalid device mode is rejected."""
        data = {
            "login_url": "https://example.com",
            "booking_date": "2025-12-01",
            "start_time": "21:30",
        ...
        assert len(errors) > 0
        assert "device_mode" in str(errors[0]["loc"])
